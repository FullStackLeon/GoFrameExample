...
func (x *AddUserResp) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AddUserResp) GetAge() string {
	if x != nil {
		return x.Age
	}
	return ""
...
var file_api_user_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x43, 0x0a, 0x0b, 0x41, 0x64, 0x64,
	...
	0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x32, 0x2e,
	0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x0b, 0x2e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x1a, 0x0c,
	0x2e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x08,
...
var file_api_user_user_proto_depIdxs = []int32{
	0, // 0: User.AddUser:input_type -> AddUserReq
	1, // 1: User.AddUser:output_type -> AddUserResp
